/**
 * heady-event-store — Service Entry Point
 * Event store — immutable sourcing, time-travel replay
 * © 2026 HeadySystems Inc. — 60+ Provisional Patents
 *
 * Domain: headysystems.com | Port: 3324
...
const SERVICE_NAME = 'heady-event-store';
