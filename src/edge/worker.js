...
const SECURITY_HEADERS = {
  ...
  'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https:; connect-src 'self' https://*.headysystems.com https://*.headyme.com https://*.headymcp.com https://*.heady-ai.com https://*.headyapi.com https://*.headyio.com https://*.headybot.com https://*.headybuddy.org https://*.headylens.com https://*.headyfinance.com https://*.headyconnection.org https://*.headyconnection.com"
};
