 ...
 *   – self-awareness.js:41   HEARTBEAT_INTERVAL_MS = 29_034
 *   – self-awareness.js:46   TELEMETRY_RING_SIZE = 500
 *   – buddy-core.js:28       MAX_LOG = 200
 *   – buddy-core.js:26       TASK_LOCK_TTL_MS = 29_034
...
const DEFAULTS = Object.freeze({
  ...
  'infra.redisUrl': {
    value: process.env.REDIS_URL || 'redis://0.0.0.0:6379',
    type: 'string',
    secret: true,
  ...
  'infra.postgresUrl': {
    value: process.env.DATABASE_URL || 'postgresql://0.0.0.0:5432/heady',
    type: 'string',
    secret: true,
